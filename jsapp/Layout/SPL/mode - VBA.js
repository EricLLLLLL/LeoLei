     ...
     Print #1, "    top.Crd.AcceptAndReadTracks('2,3', 20000); "
     Print #1, "    "
     Print #1, "    //"
     ...
     Print #1, "        top.Crd.CardInserted.connect(onCardInserted);"
     Print #1, "        top.Crd.CardAccepted.connect(onCardAccepted);"
     Print #1, "    }"
     Print #1, 
     Print #1, "    function EventLogout() {"
     Print #1, "       top.Crd.CardInserted.disconnect(onCardInserted);"
     Print #1, "       top.Crd.CardAccepted.disconnect(onCardAccepted);"
     Print #1, "    }"
     Print #1, 
